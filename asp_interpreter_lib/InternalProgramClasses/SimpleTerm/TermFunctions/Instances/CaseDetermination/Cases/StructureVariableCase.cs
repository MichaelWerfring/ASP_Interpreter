// <copyright file="StructureVariableCase.cs" company="FHWN">
...
/// <summary>
/// A class that represents a case where left is structure and right is variable.
/// </summary>
public class StructureVariableCase : IBinaryTermCase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StructureVariableCase"/> class.
    /// </summary>
