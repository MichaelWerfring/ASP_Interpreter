// <copyright file="StructureIntegerCase.cs" company="FHWN">
...
/// <summary>
/// A class that represents a case where left is structure and right is integer.
/// </summary>
public class StructureIntegerCase : IBinaryTermCase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StructureIntegerCase"/> class.
    /// </summary>
