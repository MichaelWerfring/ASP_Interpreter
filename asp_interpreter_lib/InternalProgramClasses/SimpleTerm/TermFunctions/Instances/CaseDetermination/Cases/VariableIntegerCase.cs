// <copyright file="VariableIntegerCase.cs" company="FHWN">
...
/// <summary>
/// A class that represents a case where left is variable and right is integer.
/// </summary>
public class VariableIntegerCase : IBinaryTermCase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VariableIntegerCase"/> class.
    /// </summary>
    ...
    public VariableIntegerCase(Variable left, Integer right)
    {
