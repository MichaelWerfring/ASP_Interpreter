// <copyright file="VariableStructureCase.cs" company="FHWN">
...
/// <summary>
/// A class that represents a case where left is variable and right is structure.
/// </summary>
public class VariableStructureCase : IBinaryTermCase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VariableStructureCase"/> class.
    /// </summary>
