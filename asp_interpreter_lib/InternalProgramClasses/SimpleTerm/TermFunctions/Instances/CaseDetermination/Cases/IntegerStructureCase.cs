// <copyright file="IntegerStructureCase.cs" company="FHWN">
...
/// <summary>
/// A class that represents a case where left is integer and right is structure.
/// </summary>
public class IntegerStructureCase : IBinaryTermCase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IntegerStructureCase"/> class.
    /// </summary>
