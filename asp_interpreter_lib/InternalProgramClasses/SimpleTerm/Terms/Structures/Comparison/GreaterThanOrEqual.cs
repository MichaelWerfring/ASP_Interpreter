...
namespace asp_interpreter_lib.InternalProgramClasses.SimpleTerm.Terms.Structures.Comparison;

public class GreaterThanOrEqual : IStructure
{
    public GreaterThanOrEqual(ISimpleTerm left, ISimpleTerm right)
    {
