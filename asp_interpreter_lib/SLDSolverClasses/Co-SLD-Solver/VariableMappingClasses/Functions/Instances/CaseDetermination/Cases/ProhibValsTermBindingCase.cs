...
/// <summary>
/// A class that represents a <see cref="ProhibitedValuesBinding"/> - <see cref="TermBinding"/> case.
/// </summary>
public class ProhibValsTermBindingCase : IBinaryVariableBindingCase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ProhibValsTermBindingCase"/> class.
    /// </summary>
